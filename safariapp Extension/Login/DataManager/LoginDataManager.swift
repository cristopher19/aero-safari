...
struct LoginDataManager{
    ...
    */
    func retrieveUserSoap(_ accountNumber: String, _ password: String, _ gateWay: String, completionHandler: @escaping (_ Result:UserModel?, _ Error:NSError?) -> Void) {
        ...
        let soapMessage = String(format: "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\"><soapenv:Header/><soapenv:Body><tem:AuthenticateMyAeroUser><tem:MyAeroGateway>%@</tem:MyAeroGateway><tem:MyAeroAccount>%@</tem:MyAeroAccount><tem:MyAeroPasswordMD5>%@</tem:MyAeroPasswordMD5><tem:remember>true</tem:remember><tem:DeviceID>\(UserDefaults.standard.string(forKey: "clientId")!)</tem:DeviceID><tem:MobileType>8</tem:MobileType><tem:OperatingSystemName>Mac</tem:OperatingSystemName><tem:OperatingSystemVersion>\(ProcessInfo.processInfo.operatingSystemVersion)</tem:OperatingSystemVersion><tem:DeviceBrand>Safari</tem:DeviceBrand><tem:DeviceModel>0</tem:DeviceModel><tem:AppName>\(Bundle.main.displayName ?? "")</tem:AppName><tem:AppVersion>\(Bundle.main.bundelVersion ?? "")</tem:AppVersion><tem:WebServiceSecurity_User>MyAeroChromeBeta</tem:WebServiceSecurity_User><tem:WebServiceSecurity_Password>Pmc#0Mqc!4ZaV</tem:WebServiceSecurity_Password></tem:AuthenticateMyAeroUser></soapenv:Body></soapenv:Envelope>", gateWay, accountNumber, password.md5())
